...
export type UpdatePinMutation = {
  __typename?: "Mutation";
  updatePin: { __typename?: "Pin"; id: string; name: string };
};
...
export type GetWildersQuery = {
  ...
  wilders: Array<{
    ...
    firstName: string;
    lastName: string;
    skills: Array<{ __typename?: "Skill"; id: string; skillName: string }>;
  }>;
};
...
export const DeleteWilderDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateWilder" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
