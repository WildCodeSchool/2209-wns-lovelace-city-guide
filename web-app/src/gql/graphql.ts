...
export type CreatePinMutation = { __typename?: 'Mutation', createPin: { __typename?: 'Pin', id: string, name: string, address: string, description: string, latitude: number, longitude: number, createdAt?: string | null, isAccessible: boolean, isChildFriendly: boolean, isOutdoor: boolean, categories: Array<{ __typename?: 'Category', id: string, categoryName: string }>, user: { __typename?: 'AppUser', emailAddress: string } } };
